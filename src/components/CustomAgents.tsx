  ...
  return (
    <aside className={`absolute top-0 right-0 h-full w-full sm:w-[380px] md:w-[420px] border-l shadow-2xl flex flex-col z-50 ${isDark ? "bg-[#0d1017] border-white/10" : "bg-white border-slate-200"}`}>
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4">
        {/* create */}
        <div className={`rounded-xl border p-3 flex flex-col gap-2.5 ${isDark ? "bg-[#0b0f19] border-white/10" : "bg-slate-50 border-slate-200"}`}>
        ...
        <div className="flex flex-col gap-2">
          ...
          {agents.map(a => {
            ...
            return (
              <div key={a.id} className={`rounded-xl border p-3 flex flex-col gap-2 ${isDark ? "bg-[#0c111c] border-white/5" : "bg-white border-slate-200 shadow-sm"}`}>
